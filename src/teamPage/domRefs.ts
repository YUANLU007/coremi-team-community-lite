...
export function createTeamPageDomRefs(): TeamPageDomRefs {
  return {
    ...
    attachmentButtonEl: requireElement<HTMLButtonElement>('#attachment-button'),
    attachmentInputEl: requireElement<HTMLInputElement>('#attachment-input'),
    attachmentPreviewEl: requireElement<HTMLElement>('#attachment-preview'),
