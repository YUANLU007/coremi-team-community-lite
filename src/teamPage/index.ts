...
import { createDefaultStore, repairStoreReferences } from '../group/store'
...
const { messageInputEl, attachmentButtonEl, attachmentInputEl, attachmentPreviewEl, referenceDraftEl, mentionPanelEl, errorEl, newChatNameEl, createChatFormEl, quickCreateChatEl } = teamDomRefs
...
function applyStore(nextStore: OpenTeamStore): void {
  appState.store = repairStoreReferences(nextStore)
