...
<p align="center">
  ...
  ·
  <a href="./docs/newsroom-agent-kit.md">新闻编辑部 Agent Kit</a>
</p>
...
- Coremi 私有十智能体生产级 prompt、客户数据、信源清单或付费新闻编辑室 SOP。
...
- `dist/`：构建产物，已被 Git 忽略。
- `docs/newsroom-agent-kit.md`：公开版新闻编辑部智能体工作流。
- `docs/video-slicing-workflow.md`：活动现场与采访视频切片工作流。
...
- **Coremi Newsroom Agent Kit**：本仓库包含的公开、通用新闻编辑部智能体方法。
